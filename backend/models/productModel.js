...
const materialsByCategory = {
    clothing: [
        'Cotton', 'Wool', 'Silk', 'Linen', 'Polyester', 'Rayon', 'Nylon', 'Spandex', 'Denim', 'Velvet', 'Leather'
    ],
    Accessories: [
        'Leather', 'Metal', 'Plastic', 'Acrylic', 'Glass', 'Wood', 'Rubber', 'Silicone', 'Beads', 'Pearls', 'Feathers'
    ],
    Footwear: [
        'Leather', 'Suede', 'Canvas', 'Rubber', 'Synthetic Leather', 'Mesh', 'Foam', 'PVC', 'Neoprene', 'Textile'
    ],
    Costumes: [
        'Polyester', 'Spandex', 'Nylon', 'Tulle', 'Sequins', 'Feathers', 'Faux Fur', 'Satin', 'Velvet', 'Lycra'
    ]
};
    ...
    material: {
        ...
        validate: {
            validator: function(value) {
                ...
                if (materialsByCategory[selectedCategory] && materialsByCategory[selectedCategory].includes(value)) {
                    return true;
                }
                return false;
            },
